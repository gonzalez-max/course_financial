...
export function Link_b5f13f798b997fa5e15ab92e3830c114 () {
...
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["alignItems"] : "center", ["highContrast"] : true })} direction={"column"} gap={"3"}>

<RadixThemesButton color={"grass"} css={({ ["width"] : "100%", ["paddingInlineStart"] : "140px", ["paddingInlineEnd"] : "140px" })} onClick={((...args) => (addEvents([(Event("_redirect", ({ ["path"] : "/financial_page/", ["external"] : true, ["replace"] : false }), ({  })))], args, ({  }))))} radius={"small"} size={"4"} variant={"surface"}>

{"Curso de Trading"}
</RadixThemesButton>
<RadixThemesButton color={"cyan"} css={({ ["width"] : "100%", ["paddingInlineStart"] : "140px", ["paddingInlineEnd"] : "140px" })} onClick={((...args) => (addEvents([(Event("_redirect", ({ ["path"] : "https://www.linkedin.com/in/maxi-gonzalez-479691323", ["external"] : true, ["replace"] : false }), ({  })))], args, ({  }))))} radius={"small"} size={"4"} variant={"surface"}>

{"Linkedin"}
</RadixThemesButton>
<RadixThemesButton color={"yellow"} css={({ ["width"] : "100%", ["paddingInlineStart"] : "140px", ["paddingInlineEnd"] : "140px" })} onClick={((...args) => (addEvents([(Event("_redirect", ({ ["path"] : "https://github.com/gonzalez-max", ["external"] : true, ["replace"] : false }), ({  })))], args, ({  }))))} radius={"small"} size={"4"} variant={"surface"}>

{"GitHub"}
</RadixThemesButton>
<RadixThemesButton color={"plum"} css={({ ["width"] : "100%", ["paddingInlineStart"] : "140px", ["paddingInlineEnd"] : "140px" })} onClick={((...args) => (addEvents([(Event("_redirect", ({ ["path"] : "https://www.instagram.com/maxgonzalez_ok/?next=%2F&hl=es", ["external"] : true, ["replace"] : false }), ({  })))], args, ({  }))))} radius={"small"} size={"4"} variant={"surface"}>
...
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["maxWidth"] : "600px", ["width"] : "100%", ["marginTop"] : "4em", ["marginBottom"] : "4em", ["alignItems"] : "center" })} direction={"column"} gap={"3"}>

<RadixThemesFlex align={"center"} className={"rx-Stack"} css={({ ["maxWidth"] : "400px", ["alignItems"] : "center" })} direction={"column"} gap={"3"}>

<RadixThemesAvatar css={({ ["name"] : "Maxi Gonzalez" })} fallback={"MG"} size={"6"} src={"/mi-foto-cara.jpg"}/>
<RadixThemesText as={"p"} css={({ ["color"] : "white" })} size={"2"}>

{"@Maxgonzalez_ok"}
</RadixThemesText>
<RadixThemesHeading css={({ ["color"] : "white" })} size={"4"}>

{"Bienvenidos a mi Proyecto Web"}
</RadixThemesHeading>
<RadixThemesText align={"center"} as={"p"} css={({ ["color"] : "white" })} size={"3"}>

{"Soy Maxi Gonz\u00e1lez, Programador en HTML, CSS y Python (Django framework, Reflex), Asesor financiero y agente\n                productor, me encuentro creando un curso gratuito de trading donde encontraras lo mas importante para invertir\n                en la bolsa, cripto y como evitar estafas."}
</RadixThemesText>
</RadixThemesFlex>
<Link_b5f13f798b997fa5e15ab92e3830c114/>
</RadixThemesFlex>
</RadixThemesFlex>
