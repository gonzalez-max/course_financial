        ...
        rx.center( 
            rx.vstack(
                rx.box(
                    ...
                    rx.heading("Módulo 7: Indicadores, Entradas y Salidas Exitosas",
                    ...
                    rx.text("Los indicadores técnicos son herramientas que "
                            ...
                            "entrada y salida, y la fuerza del mercado.",
                            **c_styles.TEXT_STYLE["body"]),
                    rx.text("A continuación te muestro los Indicadores Tecnicos mas importantes"
                    ...
                    rx.text("Las medias móviles son líneas en el precio para que veas la dirección "
                            ...
                            "días (puede ser 10, 50, 200, depende de la temporalidad que elijas)"
                            ...
                            **c_styles.TEXT_STYLE["body"]),
                    rx.text("Hay dos tipos principales: la simple (SMA) que solo suma y divide los precios,"
                            ...
                            "(como la de 10 días) cruza por encima de una larga (como la de 50 días), puede ser señal de compra. "
                            "Pero no es magia, solo te da una idea de la tendencia, y hay que combinarla con otras cosas.",
                            **c_styles.TEXT_STYLE["body"]),
                    ...
                    **c_styles.TEXT_STYLE["body"]),
                    ...
                    rx.text.strong("- Cruce de Medias Móviles (Golden Cross)",
                                   **c_styles.TEXT_STYLE["body"]),
                    rx.text("Entrada alcista cuando la media móvil de corto plazo (ej. 21) cruza hacia arriba las medias móviles"
                            " de largo plazo (ej. 150).",
                            **c_styles.TEXT_STYLE["body"]),
                    rx.text("Señal fuerte de cambio de tendencia al alza.",
                            **c_styles.TEXT_STYLE["body"]),
                    ...
                    rx.text("Si el precio toca repetidamente una zona de soporte clave y muestra rechazo con velas de reversión"
                            " o volumen creciente, es una señal de compra."),
                    rx.text("Confirmar con RSI en sobreventa o divergencia alcista.",
                            **c_styles.TEXT_STYLE["body"]),
                    ...
                    rx.text.strong("- Ruptura de Soporte con Volumen",
                                   **c_styles.TEXT_STYLE["body"]),
                    rx.text("Si el precio rompe una resistencia fuerte con aumento de volumen, indica una posible continuación alcista.",
                            **c_styles.TEXT_STYLE["body"]),
                    rx.text("Confirmar con cierre de vela por encima de la resistencia.",
                            **c_styles.TEXT_STYLE["body"]),
                    ...
                    rx.text.strong("- Cruce de Medias Móviles (Death Cross)",
                                   **c_styles.TEXT_STYLE["body"]),
                    rx.text("Salida bajista cuando la media móvil de corto plazo (ej. 21) cruza hacia abajo las medias móvile de "
                            "largo plazo (ej. 150).",
                            **c_styles.TEXT_STYLE["body"]),
                    rx.text("Señal de cambio de tendencia bajista.",
                            **c_styles.TEXT_STYLE["body"]),
                    ...
                    rx.text("Confirmar con velas de reversión, volumen decreciente o RSI en sobrecompra.",
                            **c_styles.TEXT_STYLE["body"]),
                    ...
                    rx.text("Si el precio rompe un soporte importante con aumento de volumen, es una señal de venta.",
                            **c_styles.TEXT_STYLE["body"]),
                    rx.text("Puede indicar el inicio de una tendencia bajista fuerte.",
                            **c_styles.TEXT_STYLE["body"]),
                    ...
                    #conclusion
                    rx.heading("Conclusión del Módulo 7:", **c_styles.TEXT_STYLE["subtitle"],
                               margin_bottom=Size.DEFAULT.value),
                    rx.list.ordered(
