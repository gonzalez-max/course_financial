            ...
            rx.vstack(
                rx.box(
                    ...
                    **c_styles.TEXT_STYLE["title"]),
                    ...
                    rx.heading("¿Qué es un perfil de inversor?",**c_styles.TEXT_STYLE["subseccion"]),
                    ...
                    rx.heading("¿Para qué sirve conocer tu perfil?", **c_styles.TEXT_STYLE["subseccion"]),
                    ...
                    rx.heading("Tipos de inversores según su tolerancia al riesgo", **c_styles.TEXT_STYLE["subseccion"]),
                    #tabla de inversores
                    rx.vstack(
                        module2_table1(),
                        margin_bottom=Size.DEFAULT.value
                    ...
                    rx.heading("¿Cómo saber qué tipo de inversor eres?", **c_styles.TEXT_STYLE["subseccion"]),
      
                    rx.text(rx.text.strong("Responde estas preguntas y descubre tu perfil:"), **c_styles.TEXT_STYLE["body"]),
      
                    rx.text("✔ ¿Cómo reaccionarías si tu inversión pierde valor en el corto plazo?",**c_styles.TEXT_STYLE["body"]),
                    rx.text("✔ ¿Prefieres estabilidad o estás dispuesto a asumir riesgos por mayor rentabilidad?",**c_styles.TEXT_STYLE["body"]),
                    rx.text("✔ ¿Cuánto tiempo estás dispuesto a mantener una inversión?",**c_styles.TEXT_STYLE["body"],
                            margin_bottom=Size.DEFAULT.value),
                    ...
                    **c_styles.TEXT_STYLE["subtitle"]),
                    ...
                    rx.heading(" ¿Como elijo el adecuado para mi perfil?", **c_styles.TEXT_STYLE["subseccion"]),
                    ...
                    #seccion 3                        
                    rx.heading("3. Diferencias entre Renta Fija y Renta Variable", **c_styles.TEXT_STYLE["subtitle"]),
                    ...
                    #Renta fija
                    rx.heading("Renta fija", **c_styles.TEXT_STYLE["subseccion"]),
                    ...
                    #tipos de fci
                    rx.heading("Tipos de FCI según sus características:", **c_styles.TEXT_STYLE["subseccion"]),
                    rx.text("1.",rx.text.strong(" Según el riesgo:"), **c_styles.TEXT_STYLE["body"], align_items="center"),
                    ...
                    rx.text("2.​",rx.text.strong(" Mercado de capitales:"), **c_styles.TEXT_STYLE["body"],
                    align_items="center"
                    ),
                    #lista de fci
                    rx.list.ordered(
                    ...
                    rx.text("3.",rx.text.strong(" Según el mercado en el que invierten:"), **c_styles.TEXT_STYLE["body"]),
                    #lista de fci
                    rx.list.ordered(
