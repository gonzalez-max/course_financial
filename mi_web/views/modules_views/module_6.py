        ...
        rx.center( 
            rx.vstack(
                rx.box(
                        ...
                        #titulo del modulo 6
                        rx.heading("Módulo 6: Tendencias y como identificarlas", **styles.TEXT_STYLE["title"]),
                        
                        #seccion 1 las tendencias
                        rx.heading("1. Las Tendencias",**styles.TEXT_STYLE["subtitle"]),
                        ...
                        #tips
                        rx.heading("Importante Recordar:",**styles.TEXT_STYLE["subseccion"]),
                        ...
                        rx.heading("2. Velocidad de las tendencias", **styles.TEXT_STYLE["subtitle"]),
                        rx.text("La velocidad de las tendencias se identifica mediante líneas dinámicas y la pendiente de la "
                                ...
                                "de la tendencia.",**styles.TEXT_STYLE["body"],margin_bottom=Size.DEFAULT.value),
                        ...
                        rx.heading("3. El enemigo de las tendencias",**styles.TEXT_STYLE["subtitle"]),
                        rx.text("El enemigo de las tendencias es el triangulo invertido, es una señal "
                                "de que el mercado esta acumulando volumen para un movimiento agresivo y "
                                "puede convertirse en una acumulacion o distribucion, "
                                "colocar un STOP-LOSS es escencial",
                                **styles.TEXT_STYLE["body"],margin_bottom=Size.DEFAULT.value),
                        ...
                        rx.heading(" ¿ Como ponemos un Stop-Loss ?", **styles.TEXT_STYLE["subseccion"]),

                        #como poner un stop loss
                        rx.text("Para colocar un stop-loss en un rango, sigue estos pasos:",
                                margin_bottom=Size.DEFAULT.value,**styles.TEXT_STYLE["body"]),
                        rx.list.ordered(
                        ...
                        rx.heading("4. Confirmación de Tendencias y Falsas Rupturas", **styles.TEXT_STYLE["subtitle"]),
                        ...
                        rx.heading("Aca te presentamos algunos tipos de rupturas:",**styles.TEXT_STYLE["subtitle"]),
                                
                        #ejemplos de cada ruptura
                        rx.heading("Ruptura resistencia",**styles.TEXT_STYLE["subseccion"]),
                        ...
                        rx.heading("Ruptura soporte",**styles.TEXT_STYLE["subseccion"]),
                        ...
                        rx.heading("Ruptura patron tecnico",**styles.TEXT_STYLE["subseccion"]),
                        ...
                        rx.heading("Falsa ruptura",**styles.TEXT_STYLE["subseccion"]),
                        ...
                        rx.heading("Conclusión del Módulo 6: ", **styles.TEXT_STYLE["subtitle"]),
                        rx.list.ordered(
