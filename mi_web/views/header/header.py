...
def header() -> rx.Component:
    return rx.vstack(
        rx.avatar(src="/mi-foto-cara.jpg",fallback="MG",size="6",name="Maxi Gonzalez"),
        rx.text("@Maxgonzalez_ok", color="white",size="2"),
        rx.heading("Bienvenidos a mi Proyecto Web",color="white",size="4"),
